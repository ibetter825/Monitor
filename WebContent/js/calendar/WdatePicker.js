...
isShowNav:true,/*当使用季度或者半年度时会导航上的小按钮会不准确使用此方法隐藏*/
isShowClear:true,
isShowToday:true,
isShowOK:true,
isShowOthers:true,
